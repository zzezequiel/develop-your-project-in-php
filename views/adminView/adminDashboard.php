                        ...
                        echo "
                            <div class='shadow-lg p-3 mb-5 bg-body rounded bg-white bg-transparent card text-white mb-1 mx-3 my-3' style='width:25rem'>
                                ...
                                <div class='row mx-2 my-2 mt-4 mb-4'>
                                    <a class='col btn btn-outline-secondary btn_sm d-flex align-items-center justify-content-center' href='?controller=Admin&action=getProduct&id=" . $products['id'] . "'>UPDATE
                                    ...
                                    <a class='col btn btn-outline-danger ms-2 btn_sm d-flex align-items-center justify-content-center' href='?controller=Employee&action=deleteProduct&id=" . $products['id'] . "'>DELETE
